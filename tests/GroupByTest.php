...
class GroupByTest extends TestCase
{
    ...
    private function getCollection(): ArrayCollection
    {
        return  new ArrayCollection([
            ['id' => 0,  'category' => 'A', 'key' => 3, 'label' => 'something', 'value' => 12],
            ['id' => 1,  'category' => 'B', 'key' => 3, 'label' => 'abra', 'value' => 4],
            ['id' => 2,  'category' => 'A', 'key' => 4, 'label' => 'cadabra', 'value' => 14],
            ['id' => 3,  'category' => 'B', 'key' => 4, 'label' => 'alacreate', 'value' => 3],
            ['id' => 4,  'category' => 'A', 'key' => 4, 'label' => 'cadabra', 'value' => 2],
            ['id' => 6,  'category' => 'B', 'key' => 4, 'label' => 'alacreate', 'value' => 8],
        ]);
    }
    ...
    public function testOrderByWithAggregators(): void
    {
        ...
        $expected = [
            1 => ['category' => 'A', 'key' => 4, 'sum(value)' => 16],
            0 => ['category' => 'A', 'key' => 3, 'sum(value)' => 12],
            3 => ['category' => 'B', 'key' => 4, 'sum(value)' => 11],
            2 => ['category' => 'B', 'key' => 3, 'sum(value)' => 4],
        ];
    ...
    public function testWhere(): void
    {
        ...
        $expected = [
            1 => ['category' => 'A', 'key' => 4, 'sum(value)' => 14],
            0 => ['category' => 'A', 'key' => 3, 'sum(value)' => 12],
            3 => ['category' => 'B', 'key' => 4, 'sum(value)' => 11],
        ];
    ...
    public function testAndWhere(): void
    {
        ...
        $expected = [
            1 => ['category' => 'A', 'key' => 4, 'sum(value)' => 16, 'sum(key)' => 8],
            3 => ['category' => 'B', 'key' => 4, 'sum(value)' => 11, 'sum(key)' => 8],
        ];
    ...
    public function testOrWhere(): void
    {
        ...
        $expected = [
            1 => ['category' => 'A', 'key' => 4, 'sum(value)' => 16, 'sum(key)' => 8],
            0 => ['category' => 'A', 'key' => 3, 'sum(value)' => 12, 'sum(key)' => 3],
            3 => ['category' => 'B', 'key' => 4, 'sum(value)' => 11, 'sum(key)' => 8],
        ];
